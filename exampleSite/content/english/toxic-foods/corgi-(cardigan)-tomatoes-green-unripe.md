---
title: "Corgi (Cardigan) and Tomatoes (Green/Unripe): What Every Owner Needs to Know"
description: "Is Tomatoes (Green/Unripe) toxic to Corgi (Cardigan)s? Learn about symptoms, severity, and what to do if your dog eats tomatoes (green/unripe). Essential safety information for Corgi (Cardigan) owners."
date: 2026-04-08
draft: false
type: "toxic-foods"
...
# Is Tomatoes (Green/Unripe) Toxic to Corgi (Cardigan)s?

**Quick Answer:**
**YES - Tomatoes (Green/Unripe) is toxic to Corgi (Cardigan)s and requires veterinary attention.**
...
## Symptoms of Tomatoes (Green/Unripe) Poisoning in Corgi (Cardigan)s

If your Corgi (Cardigan) has eaten tomatoes (green/unripe), watch for these symptoms:
...
## What to Do If Your Corgi (Cardigan) Ate Tomatoes (Green/Unripe)
...
**Tomatoes (Green/Unripe) is toxic to Corgi (Cardigan)s and can cause serious health problems.** Avoid feeding tomatoes (green/unripe) to your dog. If ingestion occurs, contact your veterinarian for guidance.

---

## Frequently Asked Questions

### How much Tomatoes (Green/Unripe) is toxic to a Corgi (Cardigan)?
...
### Can Corgi (Cardigan)s build tolerance to Tomatoes (Green/Unripe)?
...
### What if my Corgi (Cardigan) ate Tomatoes (Green/Unripe) but seems fine?

**Monitor closely and contact your vet.** Symptoms may develop over time. It's better to be safe than sorry.

### Are there any safe amounts of Tomatoes (Green/Unripe) for Corgi (Cardigan)s?
