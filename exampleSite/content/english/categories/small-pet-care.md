...
description: "All articles about Small Pet Care - Expert tips, guides, and reviews"
date: 2026-04-15
author: "Kweebs"
---
...
<section class="section">
  <div class="container">
    <header style="text-align: center; margin-bottom: 3rem;">
      <h1>Small Pet Care</h1>
      <p style="color: var(--text-secondary); max-width: 600px; margin: 1rem auto 0; font-size: 1.125rem;">
        Expert tips, guides, and reviews for Small Pet Care
      </p>
    </header>

    <div class="grid grid-3">
      {{ range where site.RegularPages "Section" "blog" }}
      {{ if in .Params.categories "small-pet-care" }}
      <article class="card">
        {{ with .Params.image }}
