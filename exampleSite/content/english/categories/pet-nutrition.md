---
title: "Pet Nutrition"
description: "All articles about Pet Nutrition - Expert tips, guides, and reviews"
date: 2026-04-15
author: "Kweebs"
---
  ...
  <div class="container">
    <header style="text-align: center; margin-bottom: 3rem;">
      ...
      <p style="color: var(--text-secondary); max-width: 600px; margin: 1rem auto 0; font-size: 1.125rem;">
        Expert tips, guides, and reviews for Pet Nutrition
      </p>
    </header>

    <div class="grid grid-3">
      {{ range where site.RegularPages "Section" "blog" }}
      {{ if in .Params.categories "pet-nutrition" }}
      <article class="card">
        {{ with .Params.image }}
