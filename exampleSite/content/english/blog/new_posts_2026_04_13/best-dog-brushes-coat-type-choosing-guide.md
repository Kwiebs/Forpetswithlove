...
1. Part the coat with one hand, exposing a line of skin
2. Brush downward from part to tips
3. Move over and create a new part, slightly overlapping the previous section
4. Continue until entire dog is brushed
